...
CLASS /ubc/2ui5_cl_srt_structdescr DEFINITION
  PUBLIC
  INHERITING FROM /ubc/2ui5_cl_srt_complexdescr
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF sabap_componentdescr,
        name       TYPE string,
        type       TYPE REF TO /ubc/2ui5_cl_srt_datadescr,
...
CLASS /ubc/2ui5_cl_srt_structdescr IMPLEMENTATION.
  METHOD constructor.
    DATA components_rtti TYPE abap_component_tab.
    DATA scomponent      TYPE sabap_componentdescr.
    DATA scomponent_rtti TYPE REF TO /ubc/2ui5_cl_srt_datadescr.
    ...
    LOOP AT components_rtti ASSIGNING <component>.
      ...
      scomponent_rtti ?= /ubc/2ui5_cl_srt_datadescr=>create_by_rtti( <component>-type ).
