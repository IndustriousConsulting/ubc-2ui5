...
CLASS ltcl_unit_test_msg_mapper IMPLEMENTATION.
  ...
  METHOD test_sy.
    ...
    DATA(lt_result) = /ubc/2ui5_cl_util_msg=>msg_get( sy ).
  ...
  METHOD test_bapiret.
    ...
    DATA(lt_result) = /ubc/2ui5_cl_util_msg=>msg_get( lt_msg[ 1 ] ).
  ...
  METHOD test_bapirettab.
    ...
    DATA(lt_result) = /ubc/2ui5_cl_util_msg=>msg_get( lt_msg ).
  ...
  METHOD test_cx.
    ...
    TRY.
      ...
      CATCH cx_root INTO DATA(lx).
        DATA(lt_result) = /ubc/2ui5_cl_util_msg=>msg_get( lx ).
    ENDTRY.
