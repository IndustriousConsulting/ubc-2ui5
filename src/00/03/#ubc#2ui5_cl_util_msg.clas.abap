CLASS /ubc/2ui5_cl_util_msg DEFINITION PUBLIC
  FINAL CREATE PUBLIC.
  PUBLIC SECTION.
    CLASS-METHODS msg_map
      IMPORTING
        name          TYPE clike
        val           TYPE data
        is_msg        TYPE /ubc/2ui5_cl_util=>ty_s_msg
      RETURNING
        VALUE(result) TYPE /ubc/2ui5_cl_util=>ty_s_msg.
...
CLASS /ubc/2ui5_cl_util_msg IMPLEMENTATION.
  METHOD msg_get.


    DATA(lv_kind) = /ubc/2ui5_cl_util=>rtti_get_type_kind( val ).
    CASE lv_kind.
      ...
      WHEN cl_abap_datadescr=>typekind_struct1 OR cl_abap_datadescr=>typekind_struct2.
        ...
        DATA(lt_attri) = /ubc/2ui5_cl_util=>rtti_get_t_attri_by_any( val ).

        DATA(ls_result) = VALUE /ubc/2ui5_cl_util=>ty_s_msg( ).
      ...
      WHEN cl_abap_datadescr=>typekind_oref.
        TRY.
            ...
            DATA(lt_attri_o) = /ubc/2ui5_cl_util=>rtti_get_t_attri_by_oref( val ).
              ...
              CATCH cx_root.
                ...
                TRY.
                  ...
                  CATCH cx_root INTO DATA(lx2).
                    ...
                    lt_attri_o = /ubc/2ui5_cl_util=>rtti_get_t_attri_by_oref( val ).
