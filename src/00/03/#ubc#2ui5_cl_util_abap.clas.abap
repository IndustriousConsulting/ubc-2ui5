CLASS /ubc/2ui5_cl_util_abap DEFINITION
  PUBLIC
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS bal_read
      IMPORTING
        ...
        id            TYPE clike
      RETURNING
        VALUE(result) TYPE /ubc/2ui5_cl_util=>ty_t_msg.
    ...
    CLASS-METHODS bal_save
      IMPORTING
        ...
        subobject TYPE clike
        id        TYPE clike
        t_log     TYPE /ubc/2ui5_cl_util=>ty_t_msg.
  ...
  PROTECTED SECTION.
    ...
    CLASS-METHODS _get_e071k_tabkey
      IMPORTING
        line             TYPE any
        dfies            TYPE /ubc/2ui5_cl_util=>ty_t_dfies
      RETURNING
...
CLASS /ubc/2ui5_cl_util_abap IMPLEMENTATION.
  ...
  METHOD rtti_get_t_fixvalues.
    ...
    DATA temp2     TYPE /ubc/2ui5_cl_util_abap=>ty_s_fix_val.
  ...
  METHOD rtti_get_classes_impl_intf.
    ...
    DATA xco_cp_abap         TYPE c LENGTH 11.
    DATA temp3               TYPE /ubc/2ui5_cl_util_abap=>ty_t_classes.
    ...
    DATA temp6 TYPE /ubc/2ui5_cl_util_abap=>ty_s_class_descr.
...
* fallback to RTTI, KEY field does not exist in S/4 2020
    ...
    DATA(lt_comp)  =  /ubc/2ui5_cl_util=>rtti_get_t_attri_by_any( tabname ).
...
*    set_row_id( ).
  ...
  METHOD bus_tr_add.
    ...
    IF /ubc/2ui5_cl_util=>context_check_abap_cloud( ).
  ...
  METHOD _set_e071k.
    ...
    DATA(t_comp) = /ubc/2ui5_cl_util=>rtti_get_t_attri_by_table_name( 'E071K' ).
    ...
    DATA(dfies) = /ubc/2ui5_cl_util=>rtti_get_t_dfies_by_table_name( iv_tabname ).
...
*    ENDIF.
  ...
  METHOD _set_e071.
    ...
    DATA(t_comp) = /ubc/2ui5_cl_util=>rtti_get_t_attri_by_table_name( 'E071' ).
  ...
  METHOD _read_e070.
    ...
    TRY.
        DATA(t_comp) = /ubc/2ui5_cl_util=>rtti_get_t_attri_by_table_name( table_name ).
