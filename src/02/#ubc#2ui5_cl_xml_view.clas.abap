CLASS /ubc/2ui5_cl_xml_view DEFINITION
  ...
  PUBLIC SECTION.
    CLASS-METHODS factory
      IMPORTING t_ns          TYPE /ubc/2ui5_if_types=>ty_t_name_value OPTIONAL
    ...
    METHODS _generic_property
      IMPORTING val           TYPE /ubc/2ui5_if_types=>ty_s_name_value OPTIONAL
      RETURNING VALUE(result) TYPE REF TO /ubc/2ui5_cl_xml_view.
    ...
    METHODS _z2ui5
      RETURNING VALUE(result) TYPE REF TO /ubc/2ui5_cl_xml_view_cc.
  ...
  METHOD planning_calendar_row.
    result = _generic( name   = `PlanningCalendarRow`
                       t_prop = VALUE #( ( n = `appointments`                    v = appointments )
                                         ...
                                         ( n = `enableAppointmentsDragAndDrop`   v = /ubc/2ui5_cl_util=>boolean_abap_2_json( enableappointmentsdraganddrop ) )
                                         ( n = `text`                            v = text )
                                       ) ).
