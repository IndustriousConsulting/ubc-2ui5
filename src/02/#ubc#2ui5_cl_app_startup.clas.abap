CLASS /ubc/2ui5_cl_app_startup DEFINITION
  PUBLIC FINAL
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      RETURNING
        VALUE(result) TYPE REF TO /ubc/2ui5_cl_app_startup.
...
CLASS /ubc/2ui5_cl_app_startup IMPLEMENTATION.
  ...
  METHOD on_event_check.
    ...
    TRY.
        ...
        ms_home-url               = /ubc/2ui5_cl_core_srv_util=>app_get_url( client    = client
  ...
  METHOD view_display_start.
    ...
    DATA(page) = /ubc/2ui5_cl_xml_view=>factory( )->shell( )->page(
    ...
    DATA(lv_url_samples2) = /ubc/2ui5_cl_core_srv_util=>app_get_url( client    = client
  ...
  METHOD view_display_popup.
    ...
    simple_form2->checkbox( enabled  = abap_false
                            selected = /ubc/2ui5_cl_util=>context_check_abap_cloud( ) ).

    DATA(lv_count) = CONV string( NEW /ubc/2ui5_cl_core_srv_draft( )->count_entries( ) ).
...
*        client->nav_app_call( z2ui5_cl_core_app_info=>factory( ) ).
  ...
  METHOD z2ui5_on_init.
    ...
    ms_home-class_editable = abap_true.
    ms_home-btn_icon       = `sap-icon://validate`.
    ms_home-classname      = /ubc/2ui5_cl_util=>rtti_get_classname_by_ref( NEW /ubc/2ui5_cl_app_hello_world( ) ).
