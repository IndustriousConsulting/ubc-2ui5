INTERFACE /ubc/2ui5_if_client
  ...
  METHODS get
    RETURNING
      VALUE(result) TYPE /ubc/2ui5_if_types=>ty_s_get.
  ...
  METHODS get_app
    ...
    RETURNING
      VALUE(result) TYPE REF TO /ubc/2ui5_if_app.

  METHODS nav_app_leave
    IMPORTING
      VALUE(app)    TYPE REF TO /ubc/2ui5_if_app OPTIONAL
    RETURNING
      VALUE(result) TYPE string.
  ...
  METHODS _event
    IMPORTING
      ...
      s_ctrl        TYPE /ubc/2ui5_if_types=>ty_s_event_control OPTIONAL
  ...
  METHODS _bind_edit
    IMPORTING
      ...
      custom_filter      TYPE REF TO /ubc/2ui5_if_ajson_filter OPTIONAL
      custom_filter_back TYPE REF TO /ubc/2ui5_if_ajson_filter OPTIONAL
      tab                TYPE data OPTIONAL
      tab_index          TYPE i    OPTIONAL
    RETURNING
      VALUE(result)      TYPE string.
