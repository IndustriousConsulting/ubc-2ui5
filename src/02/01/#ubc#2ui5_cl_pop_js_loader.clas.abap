CLASS /ubc/2ui5_cl_pop_js_loader DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO /ubc/2ui5_cl_pop_js_loader.
...
CLASS /ubc/2ui5_cl_pop_js_loader IMPLEMENTATION.
  METHOD factory.
  ...
  METHOD view_display.
    ...
    DATA(popup) = /ubc/2ui5_cl_xml_view=>factory_popup( )->dialog( `Setup UI...` )->content( ).
