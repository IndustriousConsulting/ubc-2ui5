CLASS /ubc/2ui5_cl_pop_file_ul DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO /ubc/2ui5_cl_pop_file_ul.
...
CLASS /ubc/2ui5_cl_pop_file_ul IMPLEMENTATION.
  METHOD factory.
  ...
  METHOD view_display.
    ...
    DATA(popup) = /ubc/2ui5_cl_xml_view=>factory_popup( )->dialog( title      = title
                                                               icon       = icon
  ...
  METHOD /ubc/2ui5_if_app~main.
    ...
    CASE client->get( )-event.
      ...
      WHEN `UPLOAD`.
        ...
        DATA(lv_data2) = /ubc/2ui5_cl_util=>conv_decode_x_base64( lv_data ).
        ms_result-value = /ubc/2ui5_cl_util=>conv_get_string_by_xstring( lv_data2 ).
