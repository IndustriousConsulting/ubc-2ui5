CLASS /ubc/2ui5_cl_pop_textedit DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)  TYPE REF TO /ubc/2ui5_cl_pop_textedit.
...
CLASS /ubc/2ui5_cl_pop_textedit IMPLEMENTATION.
  METHOD factory.
  ...
  METHOD display.
    ...
    DATA(popup) = /ubc/2ui5_cl_xml_view=>factory_popup( )->dialog( afterclose = client->_event( 'BUTTON_TEXTAREA_CANCEL' )
