CLASS /ubc/2ui5_cl_http_handler DEFINITION
  PUBLIC
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    CLASS-METHODS run
      IMPORTING
        ...
        config TYPE /ubc/2ui5_if_types=>ty_s_http_config OPTIONAL
    ...
    CLASS-METHODS factory_cloud
      ...
      RETURNING
        VALUE(result) TYPE REF TO /ubc/2ui5_cl_http_handler.
    ...
    CLASS-METHODS _http_post
      IMPORTING
        is_req        TYPE /ubc/2ui5_if_core_types=>ty_s_http_req
      RETURNING
        VALUE(result) TYPE /ubc/2ui5_if_core_types=>ty_s_http_res.

    CLASS-METHODS _http_get
      IMPORTING
        VALUE(is_config) TYPE  /ubc/2ui5_if_types=>ty_s_http_config
      RETURNING
        VALUE(result)    TYPE string.

    METHODS main
      IMPORTING
        s_config TYPE /ubc/2ui5_if_types=>ty_s_http_config OPTIONAL.

    CLASS-METHODS _main
      IMPORTING
        is_config     TYPE  /ubc/2ui5_if_types=>ty_s_http_config
        is_req        TYPE /ubc/2ui5_if_core_types=>ty_s_http_req
      RETURNING
        VALUE(result) TYPE /ubc/2ui5_if_core_types=>ty_s_http_res.
    ...
    CLASS-METHODS get_request
      IMPORTING
        ...
        res           TYPE REF TO object OPTIONAL
          PREFERRED PARAMETER server
      RETURNING
        VALUE(result) TYPE /ubc/2ui5_if_core_types=>ty_s_http_req.
    ...
    CLASS-METHODS get_response
      IMPORTING
        ...
        req    TYPE REF TO object OPTIONAL
        res    TYPE REF TO object OPTIONAL
        is_res TYPE /ubc/2ui5_if_core_types=>ty_s_http_res.

  PROTECTED SECTION.
    CLASS-DATA so_sticky_handler TYPE REF TO /ubc/2ui5_cl_core_handler.

    DATA mo_server TYPE REF TO /ubc/2ui5_cl_abap_api_http.

    DATA ms_req    TYPE /ubc/2ui5_if_core_types=>ty_s_http_req.
    DATA ms_res    TYPE /ubc/2ui5_if_core_types=>ty_s_http_res.
    DATA ms_config TYPE /ubc/2ui5_if_types=>ty_s_http_config.
...
CLASS /ubc/2ui5_cl_http_handler IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    IF server IS BOUND.
      result->mo_server = /ubc/2ui5_cl_abap_api_http=>factory( server ).
  ...
  METHOD factory_cloud.
    ...
    result = NEW #( ).
    result->mo_server = /ubc/2ui5_cl_abap_api_http=>factory_cloud( req = req
                                                               res = res ).
...
*      ms_req_config-src     = `https://sdk.openui5.org/nightly/2/resources/sap-ui-core.js`.
    ...
    IF is_config-styles_css IS INITIAL.
      DATA(lv_style_css) = /ubc/2ui5_cl_app_style_css=>get( ).
    ELSE.
    ...
    result = |<!DOCTYPE html>| && |\n| &&
             ...
             |      "z2ui5/controller/View1.controller.js": function()\{{ /ubc/2ui5_cl_app_view1_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/cc/Server.js": function()\{{ /ubc/2ui5_cl_app_server_js=>get( ) }\},| && |\n| &&
             |      "z2ui5/cc/DebugTool.fragment.xml": '{ /ubc/2ui5_cl_app_debugtool_xml=>get( ) }',| && |\n| &&
             |      "z2ui5/cc/DebugTool.js": function()\{{ /ubc/2ui5_cl_app_debugtool_js=>get( ) }\},| && |\n| &&
             |    \});| && |\n| &&
  ...
  METHOD _http_post.
    ...
    IF so_sticky_handler IS NOT BOUND.
      DATA(lo_post) = NEW /ubc/2ui5_cl_core_handler( is_req-body ).
    ELSE.
    ...
    TRY.
        IF lo_post IS BOUND.
          DATA(li_app) = CAST /ubc/2ui5_if_app( lo_post->mo_action->mo_app->mo_app ).
