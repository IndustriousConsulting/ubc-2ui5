CLASS /ubc/2ui5_cl_http_handler DEFINITION
  ...
  PROTECTED SECTION.
    ...
    CLASS-DATA so_sticky_handler TYPE REF TO /ubc/2ui5_cl_core_http_post.
...
CLASS /ubc/2ui5_cl_http_handler IMPLEMENTATION.
  ...
  METHOD factory_cloud.
    ...
    result = NEW #( ).
    result->mo_server = /ubc/2ui5_cl_abap_api_http=>factory_cloud(
        req = req
        res = res ).
...
*      ms_req_config-src     = `https://sdk.openui5.org/nightly/2/resources/sap-ui-core.js`.
  ...
  METHOD _http_post.
    ...
    IF so_sticky_handler IS NOT BOUND.
      DATA(lo_post) = NEW /ubc/2ui5_cl_core_http_post( is_req-body ).
    ELSE.
