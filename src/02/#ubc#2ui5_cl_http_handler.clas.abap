CLASS /ubc/2ui5_cl_http_handler DEFINITION
  ...
  PROTECTED SECTION.
    ...
    DATA mo_server TYPE REF TO /ubc/2ui5_cl_util_abap_http.
...
CLASS /ubc/2ui5_cl_http_handler IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    IF server IS BOUND.
      result->mo_server = /ubc/2ui5_cl_util_abap_http=>factory( server ).
...
*      ms_req_config-src     = `https://sdk.openui5.org/nightly/2/resources/sap-ui-core.js`.
    ...
    result = |<!DOCTYPE html>| && |\n| &&
             ...
             |      "z2ui5/Component.js": function()\{{ /ubc/2ui5_cl_app_component_js=>get( ) }{ ls_config-custom_js }\},| && |\n| &&
