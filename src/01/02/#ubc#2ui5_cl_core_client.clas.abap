CLASS /ubc/2ui5_cl_core_client DEFINITION
  PUBLIC
  CREATE PUBLIC.

  PUBLIC SECTION.
    INTERFACES /ubc/2ui5_if_client.

    DATA mo_action TYPE REF TO /ubc/2ui5_cl_core_action.

    METHODS constructor
      IMPORTING
        action TYPE REF TO /ubc/2ui5_cl_core_action.
...
CLASS /ubc/2ui5_cl_core_client IMPLEMENTATION.
  ...
  METHOD /ubc/2ui5_if_client~follow_up_action.
...
*    mo_action->ms_next-s_set-s_follow_up_action-custom_js = val.
  ...
  METHOD /ubc/2ui5_if_client~get_event_arg.
  ...
  METHOD /ubc/2ui5_if_client~get_app.

    IF id IS NOT INITIAL.
      DATA(lo_app) = /ubc/2ui5_cl_core_app=>db_load( id ).
  ...
  METHOD /ubc/2ui5_if_client~message_box_display.

    IF /ubc/2ui5_cl_util=>rtti_check_clike( text ) = abap_false.
      DATA(lt_msg) = /ubc/2ui5_cl_util=>msg_get( text ).
      IF lines( lt_msg ) = 1.
        DATA(lv_text) = lt_msg[ 1 ]-text.

        DATA(lv_type) = /ubc/2ui5_cl_util=>ui5_get_msg_type( lt_msg[ 1 ]-type ).
      ...
      ELSEIF lines( lt_msg ) > 1.
        ...
        IF title IS INITIAL.
          lv_title = SWITCH #( lt_msg[ 1 ]-type
                               ...
                               ELSE          `Information` ).
        ENDIF.
        lv_type = /ubc/2ui5_cl_util=>ui5_get_msg_type( lt_msg[ 1 ]-type ).
      ELSE.
        RETURN.
      ENDIF.
    ELSE.
  ...
  METHOD /ubc/2ui5_if_client~message_toast_display.
  ...
  METHOD /ubc/2ui5_if_client~nav_app_call.

    IF app IS NOT BOUND.
      /ubc/2ui5_cl_util=>x_raise( `NAV_APP_LEAVE_TO_INITIAL_APP_ERROR` ).
    ENDIF.

    mo_action->ms_next-o_app_call = app.

    IF app->id_app IS INITIAL.
      app->id_app = /ubc/2ui5_cl_util=>uuid_get_c32( ).
    ENDIF.
    result = app->id_app.
  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~nav_app_leave.

    IF app IS NOT SUPPLIED.
      app = /ubc/2ui5_if_client~get_app( /ubc/2ui5_if_client~get( )-s_draft-id_prev_app_stack ).
    ENDIF.
  ...
  METHOD /ubc/2ui5_if_client~nest2_view_destroy.

    mo_action->ms_next-s_set-s_view_nest2-check_update_model = abap_true.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~nest2_view_display.
  ...
  METHOD /ubc/2ui5_if_client~nest2_view_model_update.

    mo_action->ms_next-s_set-s_view_nest2-check_update_model = abap_true.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~nest_view_destroy.

    mo_action->ms_next-s_set-s_view_nest-check_update_model = abap_true.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~nest_view_display.
  ...
  METHOD /ubc/2ui5_if_client~nest_view_model_update.

    mo_action->ms_next-s_set-s_view_nest-check_update_model = abap_true.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~popover_destroy.

    mo_action->ms_next-s_set-s_popover-check_destroy = abap_true.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~popover_display.
  ...
  METHOD /ubc/2ui5_if_client~popover_model_update.

    mo_action->ms_next-s_set-s_popover-check_update_model = abap_true.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~popup_destroy.

    mo_action->ms_next-s_set-s_popup = VALUE #( check_destroy = abap_true ).

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~popup_display.
  ...
  METHOD /ubc/2ui5_if_client~popup_model_update.

    mo_action->ms_next-s_set-s_popup-check_update_model = abap_true.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~view_destroy.
  ...
  METHOD /ubc/2ui5_if_client~view_model_update.

    mo_action->ms_next-s_set-s_view-check_update_model = abap_true.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~_bind.

    DATA(lo_bind) = NEW /ubc/2ui5_cl_core_srv_bind( mo_action->mo_app ).
    result = lo_bind->main( val    = /ubc/2ui5_cl_util=>conv_get_as_data_ref( val )
                            type   = /ubc/2ui5_if_core_types=>cs_bind_type-one_way
                            config = VALUE #( path_only     = path
                                              custom_filter = custom_filter
                                              custom_mapper = custom_mapper
                                              tab           = /ubc/2ui5_cl_util=>conv_get_as_data_ref( tab )
                                              tab_index     = tab_index
  ...
  METHOD /ubc/2ui5_if_client~_bind_edit.

    DATA(lo_bind) = NEW /ubc/2ui5_cl_core_srv_bind( mo_action->mo_app ).
    result = lo_bind->main( val    = /ubc/2ui5_cl_util=>conv_get_as_data_ref( val )
                            type   = /ubc/2ui5_if_core_types=>cs_bind_type-two_way
                            config = VALUE #( path_only          = path
                                              custom_filter      = custom_filter
  ...
  METHOD /ubc/2ui5_if_client~_bind_local.
  ...
  METHOD /ubc/2ui5_if_client~_event.

    DATA(lo_ui5) = NEW /ubc/2ui5_cl_core_srv_event( ).
    ...
    IF r_data IS NOT INITIAL.
      ...
      mo_action->ms_next-r_data = /ubc/2ui5_cl_util=>conv_copy_ref_data( r_data ).
    ENDIF.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~_event_client.
  ...
  METHOD /ubc/2ui5_if_client~set_nav_back.

    mo_action->ms_next-s_set-set_nav_back = val.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~set_push_state.
  ...
  METHOD /ubc/2ui5_if_client~set_app_state_active.

    mo_action->ms_next-s_set-set_app_state_active = val.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~set_session_stateful.

    DATA(lv_check_sticky) = CAST /ubc/2ui5_if_app( mo_action->mo_app->mo_app )->check_sticky.
    ...
    IF val = abap_true.
      ...
      CAST /ubc/2ui5_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_true.
    ELSE.
      mo_action->ms_next-s_set-s_stateful-active = 0.
      CAST /ubc/2ui5_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_false.
    ENDIF.
    mo_action->ms_next-s_set-s_stateful-switched = abap_true.

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~check_app_prev_stack.

    DATA(ls_get) = /ubc/2ui5_if_client~get( ).
    result = xsdbool( ls_get-s_draft-id_prev_app_stack IS NOT INITIAL ).

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~check_on_init.

    result = xsdbool( CAST /ubc/2ui5_if_app(  mo_action->mo_app->mo_app )->check_initialized = abap_false ).

  ENDMETHOD.

  METHOD /ubc/2ui5_if_client~check_on_navigated.
  ...
  METHOD /ubc/2ui5_if_client~get_app_prev.

    DATA(ls_get) = /ubc/2ui5_if_client~get( ).
    result = /ubc/2ui5_if_client~get_app( ls_get-s_draft-id_prev_app ).
