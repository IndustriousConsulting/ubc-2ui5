CLASS /ubc/2ui5_cl_core_action DEFINITION
  ...
  PUBLIC SECTION.
    ...
    DATA mo_http_post TYPE REF TO /ubc/2ui5_cl_core_http_post.
    ...
    METHODS constructor
      IMPORTING
        val TYPE REF TO /ubc/2ui5_cl_core_http_post.
...
CLASS /ubc/2ui5_cl_core_action IMPLEMENTATION.
  ...
  METHOD factory_stack_leave.
    ...
    "check for new app?
    TRY.
        DATA(lo_draft) = NEW /ubc/2ui5_cl_core_draft_srv( ).
  ...
  METHOD factory_system_startup.
    ...
    result->mo_app->ms_draft-id          = /ubc/2ui5_cl_util=>uuid_get_c32( ).
    result->ms_actual-check_on_navigated = abap_true.
    result->mo_app->mo_app               = /ubc/2ui5_cl_core_app_startup=>factory( ).
