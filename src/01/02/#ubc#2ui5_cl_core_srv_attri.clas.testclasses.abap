...
CLASS /ubc/2ui5_cl_core_srv_attri DEFINITION LOCAL FRIENDS ltcl_test_search_attri.
...
CLASS ltcl_test_search_attri IMPLEMENTATION.
  METHOD first_test.
    ...
    DATA(lt_attri) = VALUE /ubc/2ui5_if_core_types=>ty_t_attri( ( r_ref       = lr_value
                                                              o_typedescr = cl_abap_datadescr=>describe_by_data_ref(
                                                                                lr_value )
         ) ).

    DATA(lo_model) = NEW /ubc/2ui5_cl_core_srv_attri( attri = REF #( lt_attri )
                                                  app   = lo_app_client ).
  ...
  METHOD second_test.
    ...
    DATA(lt_attri) = VALUE /ubc/2ui5_if_core_types=>ty_t_attri( ( r_ref       = REF #( lo_app_client->mv_value )
                                                              o_typedescr = cl_abap_datadescr=>describe_by_data_ref(
                                                                                lr_value )
         ) ).
  ...
  METHOD third_test.
    ...
    DATA(lt_attri) = VALUE /ubc/2ui5_if_core_types=>ty_t_attri( ( name = `1` r_ref = REF #( lo_app_client->mr_value ) )
...
CLASS ltcl_test_get_attri IMPLEMENTATION.
  METHOD first_test.
    ...
    DATA(lt_attri) = VALUE /ubc/2ui5_if_core_types=>ty_t_attri( ).
