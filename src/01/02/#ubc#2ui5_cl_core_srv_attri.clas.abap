CLASS /ubc/2ui5_cl_core_srv_attri DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS attri_search_a_dissolve
      ...
      RETURNING
        VALUE(result) TYPE REF TO /ubc/2ui5_if_core_types=>ty_s_attri.
...
CLASS /ubc/2ui5_cl_core_srv_attri IMPLEMENTATION.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri)
      ...
      TRY.
          ...
          IF lr_attri->srtti_data IS NOT INITIAL.
            ...
            <val> = /ubc/2ui5_cl_util=>xml_srtti_parse( lr_attri->srtti_data ).
...
*          DATA(lr_attri_deref)  = <table>[ name = lr_attri->name_ref ].
  ...
  METHOD attri_before_save.
    ...
    LOOP AT <tab> REFERENCE INTO DATA(lr_attri).
      ...
      IF lr_attri->bind_type = /ubc/2ui5_if_core_types=>cs_bind_type-one_time.
        DELETE mt_attri->*.
        CONTINUE.
      ENDIF.

      "extra case - conversion exit alpha numeric
      IF lr_attri->bind_type = /ubc/2ui5_if_core_types=>cs_bind_type-two_way AND (
      ...
      IF <val_ref> IS NOT INITIAL.
        ...
        IF lr_attri->name_ref IS INITIAL.
          lr_attri->srtti_data = /ubc/2ui5_cl_util=>xml_srtti_stringify( <val> ).
          CLEAR <val>.
          CLEAR <val_ref>.
          CLEAR lr_attri->r_ref.
          CONTINUE.
  ...
  METHOD attri_search_a_dissolve.
    ...
    DATA(lo_dissolve) = NEW /ubc/2ui5_cl_core_srv_diss( attri = mt_attri
                                                    app   = mo_app ).
