CLASS /ubc/2ui5_cl_core_util_srv DEFINITION
  PUBLIC
  INHERITING FROM /ubc/2ui5_cl_util
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS app_get_url_source_code
      IMPORTING
        !client       TYPE REF TO /ubc/2ui5_if_client
      RETURNING
...
CLASS /ubc/2ui5_cl_core_util_srv IMPLEMENTATION.
