INTERFACE /ubc/2ui5_if_core_types
  PUBLIC.
  ...
  TYPES:
    BEGIN OF ty_s_http_res,
      ...
      t_header      TYPE /ubc/2ui5_if_types=>ty_t_name_value,
      BEGIN OF s_stateful,
        active   TYPE i,
  ...
  TYPES:
    BEGIN OF ty_s_bind_config,
      ...
      view                 TYPE string,
      custom_mapper        TYPE REF TO /ubc/2ui5_if_ajson_mapping,
      custom_mapper_back   TYPE REF TO /ubc/2ui5_if_ajson_mapping,
      custom_filter        TYPE REF TO /ubc/2ui5_if_ajson_filter,
      custom_filter_back   TYPE REF TO /ubc/2ui5_if_ajson_filter,
  ...
  TYPES:
    BEGIN OF ty_s_attri,
      ...
      view               TYPE string,
      json_bind_local    TYPE REF TO /ubc/2ui5_if_ajson,
      custom_filter      TYPE REF TO /ubc/2ui5_if_ajson_filter,
      custom_filter_back TYPE REF TO /ubc/2ui5_if_ajson_filter,
      custom_mapper      TYPE REF TO /ubc/2ui5_if_ajson_mapping,
      custom_mapper_back TYPE REF TO /ubc/2ui5_if_ajson_mapping,
...
*      handler_attrs TYPE ty_s_http_handler_attributes,
  ...
  TYPES:
    BEGIN OF ty_s_next,
      o_app_call  TYPE REF TO /ubc/2ui5_if_app,
      o_app_leave TYPE REF TO /ubc/2ui5_if_app,
  ...
  TYPES:
    BEGIN OF ty_s_request,
      o_model TYPE REF TO /ubc/2ui5_if_ajson,
      BEGIN OF s_front,
        id          TYPE string,
        view        TYPE string,
        t_event_arg TYPE string_table,
        event       TYPE string,
        o_comp_data TYPE REF TO /ubc/2ui5_if_ajson,
        origin      TYPE string,
  ...
  TYPES:
    BEGIN OF ty_s_config,
      ...
      pathname         TYPE string,
      search           TYPE string,
      t_startup_params TYPE /ubc/2ui5_if_types=>ty_t_name_value,
    END OF ty_s_config.
