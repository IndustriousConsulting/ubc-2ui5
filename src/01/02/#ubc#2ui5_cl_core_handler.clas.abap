CLASS /ubc/2ui5_cl_core_handler DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request      TYPE /ubc/2ui5_if_core_types=>ty_s_request.
    DATA ms_response     TYPE /ubc/2ui5_if_core_types=>ty_s_response.
...
CLASS /ubc/2ui5_cl_core_handler IMPLEMENTATION.

  METHOD constructor.

    mv_request_json = val.
    mo_action = NEW /ubc/2ui5_cl_core_action( me ).
  ...
  METHOD main_begin.
    TRY.
        ...
        ELSEIF ms_request-s_control-app_start IS NOT INITIAL.
          NEW /ubc/2ui5_cl_core_srv_draft( )->cleanup( ).
  ...
  METHOD main_end.
    ...
    ms_response = VALUE #( s_front-params = mo_action->ms_next-s_set
                           ...
                           s_front-app    = /ubc/2ui5_cl_util=>rtti_get_classname_by_ref( mo_action->mo_app->mo_app )
        ).
    ...
    IF    ms_response-s_front-params-s_view-check_update_model        = abap_true
      ...
      DATA(lo_model) = NEW /ubc/2ui5_cl_core_srv_attri( attri = mo_action->mo_app->mt_attri
    ...
    IF CAST /ubc/2ui5_if_app( mo_action->mo_app->mo_app )->check_sticky = abap_false.
  ...
  METHOD main_process.
    TRY.
        ...
        DATA(li_client) = NEW /ubc/2ui5_cl_core_client( mo_action ).
        DATA(li_app)    = CAST /ubc/2ui5_if_app( mo_action->mo_app->mo_app ).
