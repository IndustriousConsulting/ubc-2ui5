CLASS /ubc/2ui5_cl_core_srv_bind DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
CLASS /ubc/2ui5_cl_core_srv_bind IMPLEMENTATION.
  ...
  METHOD main.
    ...
    DATA(lo_model) = NEW /ubc/2ui5_cl_core_srv_attri( attri = mo_app->mt_attri
                                                  app   = mo_app->mo_app ).
  ...
  METHOD main_cell.
    ...
    DATA(lo_bind) = NEW /ubc/2ui5_cl_core_srv_bind( mo_app ).
  ...
  METHOD update_model_attri.
    ...
    mr_attri->view               = COND #( WHEN ms_config-view IS INITIAL
                                           THEN /ubc/2ui5_if_client=>cs_view-main
                                           ELSE ms_config-view ).
