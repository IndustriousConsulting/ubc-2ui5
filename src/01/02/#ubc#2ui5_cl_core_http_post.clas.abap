CLASS /ubc/2ui5_cl_core_http_post DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request      TYPE /ubc/2ui5_if_core_types=>ty_s_http_request_post.
    DATA ms_response     TYPE /ubc/2ui5_if_core_types=>ty_s_http_response_post.
...
CLASS /ubc/2ui5_cl_core_http_post IMPLEMENTATION.
  ...
  METHOD main_begin.
    TRY.
        ...
        DATA(lo_json_mapper) = NEW /ubc/2ui5_cl_core_json_srv( ).
        ...
        ELSEIF ms_request-s_control-app_start IS NOT INITIAL.
          NEW /ubc/2ui5_cl_core_draft_srv( )->cleanup( ).
