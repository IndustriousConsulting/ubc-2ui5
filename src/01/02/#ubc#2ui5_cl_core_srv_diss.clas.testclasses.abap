...
CLASS /ubc/2ui5_cl_core_srv_diss DEFINITION LOCAL FRIENDS ltcl_test_dissolve.
...
CLASS ltcl_test_dissolve IMPLEMENTATION.
  METHOD test_ref.
    ...
    DATA lt_attri TYPE /ubc/2ui5_if_core_types=>ty_t_attri.
    DATA(lo_model) = NEW /ubc/2ui5_cl_core_srv_diss( attri = REF #( lt_attri )
                                                 app   = lo_app ).
